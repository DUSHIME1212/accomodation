...
export const en = {
    ...
    apartments: {
      ...
      detailDescription: "This beautifully appointed space offers a perfect blend of comfort and luxury, ensuring a memorable stay. Each detail has been carefully selected to enhance your experience, from the high-quality furnishings to the thoughtful amenities.",
      locationDescription: "Our property is ideally situated in one of the most desirable areas of Costa Bella, offering easy access to local attractions, restaurants, and shopping. The pristine beach is just steps away from your doorstep.",
      similarProperties: "Similar Properties",
      reviews: {
        title: "Guest Reviews",
        seeAll: "See all reviews",
        sampleReview: "My family and I had the most wonderful stay. The apartment was immaculate, with breathtaking sea views. The staff went above and beyond to make our vacation special. We will definitely be coming back next summer!"
      }
    },
    booking: {
      title: "Book Your Stay",
    ...
    amenitiesPage: {
      ...
      browseApartments: "Browse Our Apartments",
