...
export const it = {
    ...
    testimonials: {
      ...
      description: "Scopri perché i nostri ospiti continuano a tornare a Silver Horizon Hotel per le loro fughe al mare."
    },
    notFound: {
    ...
    apartments: {
      ...
      detailDescription: "Questo spazio splendidamente arredato offre un perfetto equilibrio tra comfort e lusso, garantendo un soggiorno memorabile. Ogni dettaglio è stato accuratamente selezionato per migliorare la tua esperienza, dagli arredi di alta qualità ai servizi premurosi.",
      locationDescription: "La nostra proprietà è situata in una delle zone più ambite di Costa Bella, offrendo facile accesso alle attrazioni locali, ristoranti e negozi. La splendida spiaggia è a pochi passi dalla tua porta.",
      similarProperties: "Proprietà Simili",
      reviews: {
        title: "Recensioni degli Ospiti",
        seeAll: "Vedi tutte le recensioni",
        sampleReview: "La mia famiglia ed io abbiamo avuto un soggiorno meraviglioso. L'appartamento era immacolato, con viste mozzafiato sul mare. Il personale ha fatto di tutto per rendere la nostra vacanza speciale. Torneremo sicuramente la prossima estate!"
      }
    },
    gallery: {
    ...
    home: {
      welcome: {
        subtitle: "Benvenuti a Silver Horizon Hotel",
        title: "Alloggi di Lusso sul Mare",
        description1: "Situato sulla incontaminata costa mediterranea, Silver Horizon Hotel offre una squisita collezione di appartamenti di lusso e camere d'albergo. I nostri alloggi fronte mare combinano un design elegante con comfort moderni, creando l'ambientazione perfetta per una indimenticabile fuga al mare.",
    ...
    amenitiesPage: {
      ...
      description: "A Silver Horizon Hotel, ci dedichiamo a fornire un'esperienza di soggiorno completa e lussuosa. Dai nostri servizi sulla spiaggia alle strutture di benessere, ogni dettaglio è stato curato per garantire il massimo comfort e piacere.",
      roomAmenities: "Servizi in Camera",
      roomDescription: "Ciascuno dei nostri alloggi è dotato di servizi premium per migliorare il tuo comfort e convenienza.",
      roomItems: {
        bedding: "Biancheria Premium",
        airConditioning: "Aria Condizionata",
        flatScreenTv: "TV a schermo piatto",
        highSpeedWifi: "WiFi ad alta velocità",
        luxuryToiletries: "Articoli da toeletta di lusso",
        coffeeMaker: "Macchina da caffè",
        minibar: "Minibar",
        safeBox: "Cassaforte",
        firstAidKit: "Kit di pronto soccorso",
        wakeUpService: "Servizio sveglia"
      },
      browseApartments: "Sfoglia i nostri appartamenti",
      viewFullGallery: "Visualizza Galleria Completa",
      categories: {
        wellness: {
