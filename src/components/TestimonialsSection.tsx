...
const testimonials: Testimonial[] = [
  {
    ...
    content: "My family and I had the most wonderful stay at Silver Horizon Hotel. The apartment was immaculate, with breathtaking sea views. The staff went above and beyond to make our vacation special.",
    rating: 5
  },
  {
    id: 2,
...
export default function TestimonialsSection() {
  ...
  return (
    <section className="overflow-hidden px-8 md:px-16 lg:px-32  bg-muted py-20">
      <div className="">
