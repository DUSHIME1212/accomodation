...
import { sanityClient, apartmentQueries } from "@/lib/GROQ/apartments";
    ...
    try {
      ...
      const apartment = await prisma.apartment.upsert({
        ...
        update: {
          ...
          slug: sanityApartment.slug,
          description: sanityApartment.description,
          basePrice: sanityApartment.basePrice,
          capacity: sanityApartment.capacity,
          size: sanityApartment.size,
          image: sanityApartment.image,
          location: sanityApartment.location,
          features: sanityApartment.features || [],
          isActive: sanityApartment.isActive ?? true,
          minNights: sanityApartment.minimumStay ?? 1,
          maxNights: sanityApartment.maximumStay ?? 30,
        },
        create: {
          sanityId,
          name: sanityApartment.name,
